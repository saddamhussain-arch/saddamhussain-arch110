...
// Vande Mataram Style Config (Slow, Majestic, Phrygian)
const defaultSoundConfig: SoundConfig = {
  enabled: true,
  masterVolume: 0.6,
  reverb: {
      enabled: true,
      mix: 0.7, // Very wet reverb for space/majestic feel
      decay: 8.0, // Long decay
      tone: 1500, // Warmer tone
  },
  drone: {
      enabled: true,
      gain: 0.5,
      filter: 80, // Deep bass
      pitch: -12, // Lower octave
  },
  atmosphere: {
      enabled: true,
      gain: 0.15,
  ...
  melody: {
      enabled: true,
      gain: 0.4,
      density: 0.3, // Sparse, slow melody
      scale: "phrygian", // Eastern/Solemn feel
  },
  arp: {
      enabled: true,
      gain: 0.2,
      speed: 0.5, // Slow pulses
      octaves: 2,
      filter: 400, // Mellow
      direction: 'updown', 
  },
  rhythm: {
      enabled: true,
      gain: 0.3,
      bpm: 45, // Very slow tempo (Adagio/Largo)
      filter: 100, // Deep drums
  },
  modulations: [
